...
use Drupal\translation_import_export\Plugin\TranslationPackage\Configuration;
...
class TranslationPackageConfiguration extends TranslationPackagePluginBase implements TranslationPackagePluginInterface {
  ...
  private $default_export_filename = 'configuration'; // The file extension will be set later
