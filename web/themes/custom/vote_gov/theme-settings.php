...
/**
 * @file
 * Functions to support theming in the vote_gov theme.
 */
 ...
 */
function vote_gov_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['theme_custom']['settings']['time_picker_style'] = [
    ...
    '#default_value' => theme_get_setting('time_picker_style', 'vote_gov'),
  ];
}
